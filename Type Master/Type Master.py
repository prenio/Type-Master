...
def typeText(name,dNames,d):
    ...
    if de[0][name] == 0.5:
        effect1 = "not very effective"
    elif de[0][name] == 1:
        effect1 ="regularly effective"
    elif de[0][name] == 2:
        effect1 ="super effective"

    if de[1][name] == 0.5:
        effect2 = "not very effective"
    elif de[1][name] == 1:
        effect2 ="regularly effective"
    elif de[1][name] == 2:
        effect2 ="super effective"

    if d2 == 0:
        return (name + " is " + effect1 + " against " + dNames[0])
    else:
        return (name + " is " + effect1 + " against " + dNames[0] + " and " + effect2 + " against " + dNames[1])
...
#Displaying the results screen
    if results_screen:
        ...
        screen.blit(b1Result,(0,height*.35))
        screen.blit(b2Result,(0,height*.45))
        screen.blit(b3Result,(0,height*.55))
        screen.blit(b4Result,(0,height*.65))
